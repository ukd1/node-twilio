...
sys.inherits(Client, RestClient);
...
sys.inherits(PhoneNumber, EventEmitter);
...
/**
 * getOutgoingPhoneNumber: Return a new OutgoingPhoneNumber object
 *
 * @param {String} num: The phone number or phone number sid.
 */
...
sys.inherits(OutgoingCall, EventEmitter);
...
sys.inherits(OutgoingSms, EventEmitter);
