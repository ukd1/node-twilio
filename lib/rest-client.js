...
//-----------------------------------------------------------------------------
//--------------------- Outgoing Phone Numbers (Caller IDs)
//-----------------------------------------------------------------------------

// Possible filters: PhoneNumber, FriendlyName
RestClient.prototype.getOutgoingNumbers = function(filters, suc, err) {
    this.apiCall('GET', '/OutgoingCallerIds', {params: filters}, suc, err);
};

RestClient.prototype.getOutgoingNumber = function(sid, suc, err) {
    if(!sid) {
