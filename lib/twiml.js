...
var Queue = module.exports.Queue = function Queue(body, attrs) {
    if(!body) {
        throw new Error('Queue noun requires body argument');
    }
...
var Enqueue = module.exports.Enqueue = function Enqueue(body, attrs) {
    var self = this;
...
var Leave = module.exports.Leave = function Leave(attrs) {
    this.type = 'Leave';
    this.nestable = {};
